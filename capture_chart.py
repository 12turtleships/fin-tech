...
A simple wrapper around screen_capture_desktop.py for capturing trading charts.
"""
...
def main():
    ...
    screen_capture_script = script_dir / "screen_capture_desktop.py"
    ...
    print("You'll be prompted to select the chart area interactively.")
    print()
